...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "dragimate", function() { return /* binding */ dragimate; });

// CONCATENATED MODULE: ./src/Modules/Globals/MouseMovement.js
/*
  Class description:
...
// CONCATENATED MODULE: ./src/Modules/Globals/HelperFunctions.js
...
// CONCATENATED MODULE: ./src/Modules/AnimationObject.js
/*
      Class description:
...
// CONCATENATED MODULE: ./src/Modules/Element.js
/*
  # Class description:
...
class Elements_Elements {
  ...
  */
  ...
  create(selector, aniObject) {
    const newElement = new Element_Element(selector, aniObject, this.mouseMovement);
...
const dragimate = new Elements_Elements();
